...
<head>
    ...
    <!-- Expeditor CSS & Scripts -->
    <link href="${pageContext.request.contextPath}/resources/stylesheets/gestionArticle.css" rel="stylesheet"
          type="text/css"/>
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/gestionArticle.js"></script>
</head>
<body>
    ...
    <form action="GestionArticleServlet" method="post">
        ...
        <div class="actions">
            <button type="submit" class="ui button positive inverted"
                    value="archiver" name="action">Oui
            </button>
