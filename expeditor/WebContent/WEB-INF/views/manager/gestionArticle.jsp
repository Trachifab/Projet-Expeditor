...
<div class="ui equal width center aligned padded grid">
    <div class="row">
        ...
        <div class="twelve wide column">
                ...
                <tr class="positive">
                    ...
                    <td>
                        <div class="field">
                            ...
                            <button class="ui icon red small button"
            ...
            %>
            <button type="button" value="ajouter" class="ui green center aligned animated button"
...
<div id="popupArticle" class="ui small modal">
    <form class="ui equal width form" method="post" action="GestionArticleServlet">
        ...
        <div class="fields">
            <div class="field">
                <label>Libelle</label> <input type="text" maxlength="50" name="articleLibelle" required="required" />
            </div>
            <div class="field">
